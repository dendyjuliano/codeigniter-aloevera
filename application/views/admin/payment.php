                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('admin/detail_payment/') ?><?= $ad['kode_pembayaran'] ?>"><i class="fas fa-search-plus"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
