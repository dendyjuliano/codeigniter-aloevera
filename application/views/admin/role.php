					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?= $row->role ?></td>
								<td>
									<a class="btn btn-danger tombol-hapus" href="<?= base_url('admin/delete_role/') ?><?= $row->id ?>"><i class="fas fa-trash"></i></a>
									<a class="btn btn-success" href="<?= base_url('admin/edit_role/') ?><?= $row->id ?>"><i class="fas fa-edit"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
			...
			<div class="modal-body">
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="name" name="role" placeholder="Input Role Name">
					</div>
			</div>
