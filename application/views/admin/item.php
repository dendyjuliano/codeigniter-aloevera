...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center mb-4">
		...
		<div class="buton ml-auto">
			<a href="<?= base_url('admin/pdf_item') ?>" class="btn btn-danger btn-sm">Print to PDF</a>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?= $row['stok'] ?></td>
								<td>
									<a class="btn btn-danger tombol-hapus" href="<?= base_url('admin/delete_item/') ?><?= $row['id'] ?>"><i class="fas fa-trash"></i></a>
									<a class="btn btn-success" href="<?= base_url('admin/edit_item/') ?><?= $row['id'] ?>"><i class="fas fa-edit"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
			...
			<form action="" method="post">
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="name" name="nama" placeholder="Input Name" autocomplete="off">
					</div>
					<div class="form-group">
